...
$(document).on("click", ".add-to-cart", function () {
  var pizza = JSON.parse($(this).attr('data-pizza'));
  updatecart(pizza);
});
...
var socket = io(); //join for order status 
...
if (adminAreaPath.includes('admin')) {
  ...
  Object(_admin_js__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(socket);
} // join for item add, update, delete


socket.emit('join', 'productRoom');
Object(_home_js__WEBPACK_IMPORTED_MODULE_3__["initProduct"])(socket);
socket.on('orderUpdated', function (data) {
  var updateOrder = _objectSpread({}, order);

  updateOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_5___default()().format();
...
Object(_stripe_js__WEBPACK_IMPORTED_MODULE_4__["initStripe"])();
...
function initProduct(socket) {
  var orderTableBody = document.querySelector('#productDivBody');
  var pizzas = [];
  var markup;
  var role;
  ...
  socket.on('itemDeleted', function (pizza) {
    // new Noty({
    //     type: 'success',
    //     timeout: 1000,
    //     progressBar: false,
...
/* harmony import */ var _apiService_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./apiService.js */ "./resources/js/apiService.js");
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51K0QNcSCFBViUBjftSIHgQItqlznKLrxxVOybcd2tv55QlFyiDZhPuJB3tgTO4E2kIkbPGXqEYjBs3ZZ9Rbyth1B00sb6NgZWD');
...
__webpack_require__(/*! C:\Users\HP\Desktop\node2.0\realtime-pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\HP\Desktop\node2.0\realtime-pizza\resources\scss\app.scss */"./resources/scss/app.scss");
